...
export default function Income() {
  return (
    <div className="flex flex-col items-start w-[384px] h-[215px] rounded-[12px] bg-[#FFF]">
      ...
      <div className="flex flex-col items-start px-6 py-4 gap-6">
        <div className="flex flex-col items-start">
          <h1 className="text-[#000] text-[36px] font-semibold">1,200,000</h1>
          <p>Your Income account</p>
        </div>

        <div className="flex items-center gap-2">
          <LeadingIcon />
          <p className="text-[#000]">32% from last month</p>
        </div>
      </div>
    </div>
  );
